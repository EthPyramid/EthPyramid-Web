...
function updateEthPrice() {
	$.getJSON( 'https://api.coinmarketcap.com/v1/ticker/ethereum/?convert=AUD', function( result ) {
		var eth = result[0];
		ethPrice = parseFloat( eth.price_aud );
