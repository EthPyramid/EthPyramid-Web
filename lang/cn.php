...
return [
	...
	'text' => [
		...
		'To buy EPY, simply click the "Buy Tokens" button and enter the amount of Ether you want to convert to EPY, based on the current Buy Price. When confirming the transaction on MetaMask, be sure to use a high enough gas price so that the price doesn\'t change drastically while the transaction is in progress.	<a href="https://ethgasstation.info/">Here</a> you can view recommended gas prices.	Buying coins will increase both the Buy Price and Sell Price with 0.25% per bought coin once the transaction is complete.' => '要购买以太金字塔代币，只需点击“购买代币”按钮，然后根据当前的购买价格输入您想要转换为以太金字塔代币的以太数量。在MetaMask上确认交易时，请确保有足够的金额，以便在交易过程中价格不会发生剧烈变化。<a href="https://ethgasstation.info/">在这</a>里你可以查看建议金额。购买代币会使购买价格和出售价格增加，每购买一个代币，交易完成后，购买价格和出售价格都会增加0.25％。',
		'Under "EthPyramid Token Balance" you can see how many EPY you currently own. Note that when cashing out coins, the Buy Price and Sell Price drop afterwards, decreasing the value of your (and everyone else\'s) coins by 0.25% per coin.' => '在“以太金字塔代币余额”里，你可以看到你当前拥有多少以太金字塔代币。请注意，当提现代币时，购买价格和出售价格会随之下降，你的（和其他人的）代币的价值都会降低0.25%。',
